...
const cacheName = 'FixitLevelUp3KatieSullivan-2020-10-05 09:43:12.366717'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FixitLevelUp3KatieSullivan'.length) === 'FixitLevelUp3KatieSullivan') {
